...
CREATE TABLE `Crm_Bills` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='客户消费记录';
...
INSERT INTO `Crm_Bills` VALUES (1,1,1,1,10.21,NULL,'衣服',23.00,2,'2014-04-07 05:13:49'),(2,2,1,2,NULL,44,'裤子',44.30,55,'2014-04-07 06:19:10');
