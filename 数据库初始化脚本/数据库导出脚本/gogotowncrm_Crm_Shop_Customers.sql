...
CREATE TABLE `Crm_Shop_Customers` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='商家客户关联表';
...
INSERT INTO `Crm_Shop_Customers` VALUES (1,1,1,2,1,1396352520),(2,1,2,2,1,1396342520),(3,1,3,2,2,1396322520),(4,1,4,2,3,1396452520),(5,1,5,2,3,1397352520),(6,1,1,1,4,1396452520),(7,1,2,1,4,1397351520),(8,1,24,1,4,1396576602);
