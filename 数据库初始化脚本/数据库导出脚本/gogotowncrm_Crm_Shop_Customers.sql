...
CREATE TABLE `Crm_Shop_Customers` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='商家客户关联表';
...
-- Dump completed on 2014-04-14 20:40:03
