...
CREATE TABLE `Crm_Rank` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='客户等级';
...
INSERT INTO `Crm_Rank` VALUES (3,2,1,4,1,NULL,NULL,'2014-04-18 06:30:40'),(2,1,1,31,2,11,1,'2014-04-14 10:14:55');
